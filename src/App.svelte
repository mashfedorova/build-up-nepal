...
<div class="intro-container">
  ...
  <div class="intro-paragraph">
    <img
      ...
      alt="logo build up nepal"
    />
    <h1 id="main-title">Build-up Nepal</h1>
    <p id="subtitle">an interactive story</p>
    <p class="intro-text">
      Build up Nepal is on a mission to break the vicious poverty cycle in rural
      Nepal through safe houses and long-term jobs for poor families.This is
      important because millions of families in rural Nepal live in deep poverty
      and are forced to migrate from their villages due to lack of jobs,
      housing, and economic development. The construction industry in Nepal are
...
<div class="article" id="footer">
  <div>
    <img id="vsg-logo" width="400px" src="images/logo.png" alt="logo" />
    <p class="byline">
